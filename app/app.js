...
const sellerMessageRoutes = require("./routes/seller/message.routes");
const subAdminMessageRoutes = require("./routes/subAdmin/message.routes");
...
const allowedOrigins = ['http://localhost:3000','http://localhost:3001', 'http://gwtechsoft.com', 'http://204.12.203.235','https://lottery-softfront.onrender.com','https://lotterysoft.net'];
app.use(cors({
...
reports(app);
sellerRoutes(app);
sellerMessageRoutes(app);
subadminWinNumberRoutes(app);
subAdminMessageRoutes(app);
PercentageLimit(app);
...
paymentAlertsubAdminRoutes(app);
